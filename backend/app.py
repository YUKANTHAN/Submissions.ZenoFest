...
def _serve_frontend_html():
    """Serve index.html with the event definitions embedded inline and
    no-store caching so the form renders instantly with no fetch wait."""
...
def ppt_template():
    ...
    ppt_path = os.path.normpath(os.path.join(BACKEND_DIR, "Project_expo_template_ppt.pptx"))
